...
public class GrantAccountForm extends javax.swing.JFrame {
    //log4j
    private final static Logger logger = LogManager.getLogger(GrantAccountForm.class);
    Connection con;
    private String skipuser; //bỏ qua tài khoản đang đăng nhập    
     ...
     */
    public GrantAccountForm(String skipuser) {
    ...
    public void main() {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new GrantAccountForm(skipuser).setVisible(true);
        });
    }
