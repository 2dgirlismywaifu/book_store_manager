 ...
 * @author honkaiwaifu
 */
public final class BookPublishers extends javax.swing.JFrame {
    //log4j
    private final static Logger logger = LogManager.getLogger(BookPublishers.class);
    ...
    public BookPublishers() {
        iconImageUtilities.setWindowImage(this);
        initComponents();
        User_load();
    }
   ...
   //Tìm kiếm bản ghi
    ...
    public void main() {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new BookPublishers().setVisible(true);
        });
    }
