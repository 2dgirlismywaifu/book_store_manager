...
public class BookInformation extends javax.swing.JFrame {
    ...
    //log4j
    private final static Logger logger = LogManager.getLogger(BookInformation.class);
    ...
    public BookInformation() {
        iconImageUtilities.setWindowImage(BookInformation.this);
        initComponents();       
        User_load();
    }
    ...
    private void addNHACUNGCAP() {
        ...
        convertPrice = Integer.valueOf(price);
        convertSL = Integer.valueOf(amount);
