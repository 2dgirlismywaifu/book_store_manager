...
public final class SalerForm extends javax.swing.JFrame {
    //log4j
    private final static Logger logger = LogManager.getLogger(SalerForm.class);
     ...
     */
    public SalerForm(String username) {
        this.getusername = username;
        initComponents();
        iconImageUtilities.setWindowImage(SalerForm.this);
        User_load();
    }
    ...
    public void main() {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new SalerForm(getusername).setVisible(true);
        });
    }
