...
public final class BillDetail extends javax.swing.JFrame {
    //log4j
    private final static Logger logger = LogManager.getLogger(BillDetail.class);
     ...
     */
    public BillDetail() {
        iconImageUtilities.setWindowImage(BillDetail.this);
        initComponents();
        User_load();
    }
