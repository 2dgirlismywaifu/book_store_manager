...
public final class BillHistory extends javax.swing.JFrame {
    //log4j
    private final static Logger logger = LogManager.getLogger(BillHistory.class);
     ...
     */
    public BillHistory() {
        iconImageUtilities.setWindowImage(BillHistory.this);
        initComponents();
        User_load();
    }
