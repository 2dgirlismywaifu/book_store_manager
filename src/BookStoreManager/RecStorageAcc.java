 ...
 * @author honkaiwaifu
 */
public final class RecStorageAcc extends javax.swing.JFrame {
        ...
        // TODO add your handling code here:
         try {
            ...
            if (rs.next()) {
                ...
                Logger.getLogger(RecStorageAcc.class.getName()).log(Level.SEVERE, null, ex);
            }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecStorageAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            RecStorageAcc rk = new RecStorageAcc();
            rk.setVisible(true);
