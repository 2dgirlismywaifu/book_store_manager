 ...
 * @author honkaiwaifu
 */
public final class RecSalerAcc extends javax.swing.JFrame {
        ...
        // TODO add your handling code here:
         try {
            ...
            if (rs.next()) {
                ...
                Logger.getLogger(RecSalerAcc.class.getName()).log(Level.SEVERE, null, ex);
            }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecSalerAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            RecSalerAcc rk = new RecSalerAcc();
            rk.setVisible(true);
