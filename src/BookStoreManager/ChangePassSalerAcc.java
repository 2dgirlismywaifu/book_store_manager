 ...
 * @author honkaiwaifu
 */
public class ChangePassSalerAcc extends javax.swing.JFrame {

    Connection con = NewConnection.getConnection();
    /**
     * Creates new form ChangePassword
     */
    public ChangePassSalerAcc() {
        initComponents();
        SalerAccInfo.setText(SalerPageForm.SalerAcc.getText());
    }
        ...
        confpass = confirmpassword.getText() ;
         ...
         if(oldpass.equals("")){
            ...
            try {
               ...
               java.util.logging.Logger.getLogger(ChangePassSalerAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                }           
         } 
    }
