 ...
 * @author honkaiwaifu
 */
public class ChangePassAdminAcc extends javax.swing.JFrame {

    Connection con = NewConnection.getConnection();
    /**
     * Creates new form ChangePassword
     */
    public ChangePassAdminAcc() {
        initComponents();
        usernamelabel.setText(AdminPageForm.UserName.getText());
    }
        ...
        confpass = confirmpassword.getText() ;
         ...
         if(oldpass.equals("")){
            ...
            try {
               ...
               java.util.logging.Logger.getLogger(ChangePassAdminAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                }           
         } 
    }
